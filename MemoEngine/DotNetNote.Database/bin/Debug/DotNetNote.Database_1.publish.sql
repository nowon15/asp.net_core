...
GO
PRINT N'테이블 [dbo].[NoteComments]을(를) 만드는 중...';
...
GO
PRINT N'테이블 [dbo].[Notes]을(를) 만드는 중...';
...
GO
PRINT N'DEFAULT 제약 조건 [dbo].[NoteComments]에 대한 명명되지 않은 제약 조건을(를) 만드는 중...';
...
GO
PRINT N'DEFAULT 제약 조건 [dbo].[Notes]에 대한 명명되지 않은 제약 조건을(를) 만드는 중...';
...
GO
PRINT N'프로시저 [dbo].[DeleteNote]을(를) 만드는 중...';
...
As
    ...
    End
GO
PRINT N'프로시저 [dbo].[GetCountNotes]을(를) 만드는 중...';
...
GO
PRINT N'프로시저 [dbo].[ListNotes]을(를) 만드는 중...';
...
GO
PRINT N'프로시저 [dbo].[ModifyNote]을(를) 만드는 중...';
...
As
    ...
    Else
        Select '0'
GO
PRINT N'프로시저 [dbo].[ReplyNote]을(를) 만드는 중...';
...
GO
PRINT N'프로시저 [dbo].[SearchNoteCount]을(를) 만드는 중...';
...
As
    ...
    @SearchQuery
GO
PRINT N'프로시저 [dbo].[SearchNotes]을(를) 만드는 중...';
...
As
    ...
    Order By Id Desc
GO
PRINT N'프로시저 [dbo].[ViewNote]을(를) 만드는 중...';
...
GO
PRINT N'프로시저 [dbo].[WriteNote]을(를) 만드는 중...';
